              ...
              <tbody>
                <?php foreach ($seeds as $seed): ?>
                   <tr>
                      ...
                      <td>    
                        <a class="btn btn-primary" href="update_seed.php?id=<?php echo $seed['seed_id'];?>">Edit</a>
                        <form action="" method="post" style="display: inline-block;">
                            <input type="hidden" name="seed_id" value="<?php echo $seed['seed_id']; ?>">
                            <button name="delete" onclick="return myConfirm();" class="btn btn-danger" id="">Delete</button>
                        </form>
                    </td>
                </tr>
            <?php endforeach; ?>
